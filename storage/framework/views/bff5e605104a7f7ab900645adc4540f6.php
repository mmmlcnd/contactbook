<?php $__env->startSection('title', '生徒ログイン'); ?>

<?php $__env->startSection('form'); ?>
<form method="POST" action="<?php echo e(route('login.student')); ?>">
    <?php echo csrf_field(); ?>
    <div class="mb-4">
...
<?php echo $__env->make('layouts.login', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\contactbook\resources\views/auth/student_login.blade.php ENDPATH**/ ?>