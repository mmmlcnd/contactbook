    ...
    <div class="max-w-xl mx-auto bg-white shadow-2xl rounded-2xl p-6 md:p-10 border border-gray-100">
        ...
        <div class="text-center mb-8 border-b pb-4">
            ...
            <p class="text-xl text-gray-600 font-medium">
                ようこそ、<span class="text-red-600 font-bold">{{ $_SESSION['user_name'] ?? 'ゲスト' }}</span> さん
            </p>
        </div>
        ...
        <div class="space-y-6">
            ...
            <!-- アカウント管理カード -->
            <a href="{{ route('admins.create') }}" class="block p-5 bg-red-50 hover:bg-red-100 border border-red-200 rounded-xl transition duration-300 ease-in-out transform hover:scale-[1.01] shadow-md">
