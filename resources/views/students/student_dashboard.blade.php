    ...
    <div class="max-w-xl mx-auto bg-white shadow-2xl rounded-2xl p-6 md:p-10 border border-gray-100">
        ...
        <div class="text-center mb-8 border-b pb-4">
            ...
            <p class="text-xl text-gray-600 font-medium">
                ようこそ、<span class="text-indigo-600 font-bold">{{ $_SESSION['user_name'] ?? 'ゲスト' }}</span> さん
            </p>
        </div>
        ...
        <div class="space-y-6">
            ...
            <!-- 連絡帳提出カード -->
            <a href="{{ route('students.entries.create') }}" class="block p-5 bg-indigo-50 hover:bg-indigo-100 border border-indigo-200 rounded-xl transition duration-300 ease-in-out transform hover:scale-[1.01] shadow-md">
            ...
            <!-- 過去の提出記録カード -->
            <a href="{{ route('students.entries.past') }}" class="block p-5 bg-teal-50 hover:bg-teal-100 border border-teal-200 rounded-xl transition duration-300 ease-in-out transform hover:scale-[1.01] shadow-md">
                <div class="flex items-center">
