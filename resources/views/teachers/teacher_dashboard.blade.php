    ...
    <div class="max-w-xl mx-auto bg-white shadow-2xl rounded-2xl p-6 md:p-10 border border-gray-100">
        ...
        <div class="text-center mb-8 border-b pb-4">
            ...
            <p class="text-xl text-gray-600 font-medium">
                ようこそ、<span class="text-green-600 font-bold">{{ $_SESSION['user_name'] ?? 'ゲスト' }}</span> 先生
            </p>
        </div>
        ...
        <div class="space-y-6">
            ...
            <!-- 提出状況確認カード -->
            <a href="{{ route('teachers.status') }}" class="block p-5 bg-green-50 hover:bg-green-100 border border-green-200 rounded-xl transition duration-300 ease-in-out transform hover:scale-[1.01] shadow-md">
            ...
            <!-- 過去の記録確認カード -->
            <a href="{{ route('teachers.entries.past') }}" class="block p-5 bg-lime-50 hover:bg-lime-100 border border-lime-200 rounded-xl transition duration-300 ease-in-out transform hover:scale-[1.01] shadow-md">
                <div class="flex items-center">
